...
class SpiderConfig:
    ...
    def __init__(self, cookie, user_agent, folder_path, chrome_path):
        ...
        self.chrome_path = chrome_path + os.path.sep

    def default_harder(self):
        self.user_agent = "ttwid=1%7CvTO_uJ7LmaveRIOE8nlIwh0MF9NA5UKrFYGNozKNQKM%7C1682424504"
        ...
        self.folder_path = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3"
